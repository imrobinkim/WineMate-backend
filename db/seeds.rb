...
##############  WINES  ###############
Wine.create(name: "Malbec", img: "https://www.rudewines.co.uk/media/catalog/product/cache/1/image/9df78eab33525d08d6e5fb8d27136e95/m/i/mix168r.jpg", wine_style: bold_red)
Wine.create(name: "Syrah (Shiraz)", img: "https://cdn.images.express.co.uk/img/dynamic/14/590x/secondary/wine-277356.jpg", wine_style: bold_red)
...
Wine.create(name: "Barbera", img: "https://keyassets.timeincuk.net/inspirewp/live/wp-content/uploads/sites/34/2016/05/Barbera-dAsti-and-Nizza-wines-for-summer.jpg", wine_style: medium_red)
